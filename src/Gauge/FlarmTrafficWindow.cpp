...
const Color FlarmTrafficWindow::hcStandard(Color::BLACK);
const Color FlarmTrafficWindow::hcSelection(Color::BLUE);
const Color FlarmTrafficWindow::hcTeam(Color::YELLOW);
const Color FlarmTrafficWindow::hcBackground(Color::WHITE);
const Color FlarmTrafficWindow::hcRadar(Color::LIGHT_GRAY);
...
FlarmTrafficWindow::on_create()
{
  ...
  hpPassive.set(width, Color::BLACK);
