...
#ifndef XCSOAR_KEYBOARD_PANEL_HPP
#define XCSOAR_KEYBOARD_PANEL_HPP
...
public:
   ...
   */
  KeyboardControl(WndForm &form, ContainerControl *owner,
                  int x, int y, unsigned width, unsigned height,
                  const WindowStyle _style = WindowStyle());

private:
  void add_button(WndForm &form, ContainerControl *owner,
                  const TCHAR* name, const TCHAR* caption,
                  WndButton::ClickNotifyCallback_t Function = NULL);
};
