...
ButtonLook::Initialise(const Font &_font)
{
  ...
  standard.background_color = COLOR_WHITE;
  ...
  focused.foreground_color = COLOR_BLACK;
  focused.foreground_brush.Set(standard.foreground_color);
  focused.background_color = COLOR_GRAY_1;
  focused.light_border_pen.Set(1, LightColor(standard.background_color));
  focused.dark_border_pen.Set(1, DarkColor(standard.background_color));
